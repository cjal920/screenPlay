...
//fades out after 5 seconds//
  ...
  $("#lr-syn2").html(synopsisLeahRose[1]).delay(4500).fadeIn(1000).delay(2000).fadeOut(500);
  // $("#outdoor-party").delay(8000).fadeIn(500).delay(5000).fadeOut(17500);
  $("#lr-syn3").html(synopsisLeahRose[2]).delay(11000).fadeIn(500).delay(45000).fadeOut(500);
  $("#lr-syn4").html(synopsisLeahRose[3]).delay(15000).fadeIn(500).delay(41000).fadeOut(500);
  $("#lr-syn5").html(synopsisLeahRose[4]).delay(20000).fadeIn(500).delay(36000).fadeOut(500);
  $("#lr-syn6").html(synopsisLeahRose[5]).delay(29000).fadeIn(500).delay(27000).fadeOut(500);
  $("#lr-syn7").html(synopsisLeahRose[6]).delay(37000).fadeIn(500).delay(19000).fadeOut(500);
  $("#lr-syn8").html(synopsisLeahRose[7]).delay(45000).fadeIn(500).delay(11000).fadeOut(500);
...
//fades out after 43 seconds//
  $("#leah-rose-tag").html(tagTitle[0]).delay(62000).fadeIn(500).delay(7000).fadeOut(1000);
  $(".leah-rose-title-two").html(tagTitle[1]).delay(65000).fadeIn(1000).delay(3500).fadeOut(1000);
